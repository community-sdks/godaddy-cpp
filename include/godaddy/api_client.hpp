...
public:
    ...
    Result request(const std::string& method, const std::string& service_name, const std::string& path,
...
private:
    std::string resolve_base_url(const std::string& service_name) const;
